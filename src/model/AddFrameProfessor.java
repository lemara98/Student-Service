...
public class AddFrameProfessor extends JDialog {
	...
	/**
	 * Konstruktor bez parametara koji otvara formular za dodavanje profesora
	 */
	...
	/**
	 * dodavvanje predmeta na desni panel
	 * @param panel
	 * @param subject
	 * @param rbr
	 */
	...
	/**
	 * citanje selektovanih cek boksova sa predmetima
	 * @param c
	 * @param dodavaniProfa
	 * @return
	 */
